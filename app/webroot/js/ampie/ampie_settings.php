...
<settings>
  ...
  <pie>
    <x>50%</x>                                                <!-- [50%](Number / Number% / !Number) -->
    <y>27%</y>                                                <!-- [45%](Number / Number% / !Number) -->
    <radius>18%</radius>                                      <!-- [25%] (Number / Number%)  -->
    <inner_radius>20%</inner_radius>                          <!-- [0] (Number / Number%) the radius of the hole (if you want to have donut, use > 0) -->
    ...
    <gradient>linear</gradient>                               <!-- [] (linear/radial) Allows slices to be filled with gradient colors -->
    <gradient_ratio>-10,60</gradient_ratio>                   <!-- [0,-40] (Numbers from (-255 to 255) separated by commas) Controls the gradient ratio -->
  </pie>

  <animation>
    <start_time>1</start_time>                                <!-- [0] (Number) fly-in time in seconds. Leave 0 to appear instantly -->
    <start_effect>regular</start_effect>                      <!-- [bounce] (bounce, regular, strong) -->
    <start_radius>150%</start_radius>                         <!-- [500%] (Number / Number%) -->
    ...
    <pull_out_effect>regular</pull_out_effect>                <!-- [bounce] (bounce, regular, strong) -->
  ...
  <data_labels>
    <radius>25%</radius>                                      <!-- [20%] (Number / Number%) distance of the labels from the pie. Use negative value to place labels on the pie -->
    <text_color></text_color>                                 <!-- [text_color] (hex color code) -->
    <text_size></text_size>                                   <!-- [text_size] (Number) -->
    <max_width>150</max_width>                                <!-- [120] (Number) -->
    <show>
  ...
  <balloon>                                                   <!-- BALLOON -->
    ...
    <text_size></text_size>                                   <!-- [text_size] (Number) -->
    <show>
       <![CDATA[{description}]]>                              <!-- [{title}: {percents}% ({value}) <br> {description}] ({value} {title} {percents} {description}) You can format any data label: {value} - will be replaced with value and so on. You can add your own text or html code too. -->
    </show>
    <max_width>350</max_width>                                <!-- [220] (Number) The maximum width of a balloon -->
  ...
  <legend>                                                    <!-- LEGEND -->
    ...
    <x>1</x>                                                  <!-- [5%] (Number / Number% / !Number) -->
    <y>400</y>                                                <!-- [] (Number / Number% / !Number) if empty, will be placed below the pie -->
    <width>99%</width>                                        <!-- [90%] (Number / Number%) -->
    <color></color>                                           <!-- [#FFFFFF] (hex color code) background color. Separate color codes with comas for gradient -->
    <max_columns>3</max_columns>                              <!-- [] (Number) the maximum number of columns in the legend -->
    ...
    <align>left</align>                                       <!-- [left] (left / center / right) alignment of legend entries -->
    ...
    <values>                                                  <!-- VALUES -->
      ...
      <width>0</width>                                        <!-- [] (Number) width of value text (use it if you want to align all values to the right, othervise leave empty) -->
