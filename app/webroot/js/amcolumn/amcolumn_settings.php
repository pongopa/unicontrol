...
<settings>
  ...
  <column>
    <type>3d column</type>                                    <!-- [clustered] (clustered, stacked, 100% stacked, 3d column) -->
    <width>30</width>                                         <!-- [80] (0 - 100) width of column (in percents)  -->
    ...
    <data_labels>
      <![CDATA[{value} Bs.]]>                                  <!-- [] ({title} {value} {series} {percents} {start} {difference} {total}) You can format any data label: {title} will be replaced with real title, {value} - with value and so on. You can add your own text or html code too. -->
    </data_labels>
    <data_labels_text_color>#000000</data_labels_text_color>  <!-- [text_color] (hex color code) -->
    <data_labels_text_size>12</data_labels_text_size>         <!-- [text_size] (Number) -->
    ...
    <data_labels_always_on>true</data_labels_always_on>       <!-- [false] (true / false) If the data label is placed inside of the bar or column (stacked chart) and the bar or column is too small for the label to fit, it is hidden. If you set this setting to "true", the data labels will always be visible. -->
    <balloon_text>
      <![CDATA[{value} Bs.]]>                                  <!-- [] ({title} {value} {series} {percents} {start} {difference} {total}) You can format any data label: {title} will be replaced with real title, {value} - with value and so on. You can add your own text or html code too. -->
    </balloon_text>
  ...
  <plot_area>                                                 <!-- PLOT AREA (the area between axes) -->
    ...
    <margins>                                                 <!-- plot area margins -->
      <left>0</left>                                         <!-- [60](Number / Number%) -->
      <top>80</top>                                           <!-- [60](Number / Number%) -->
      <right>80</right>                                       <!-- [60](Number / Number%) -->
  ...
  <legend>                                                    <!-- LEGEND -->
    ...
    <reverse_order>false</reverse_order>                       <!-- [false] (true / false) whether to sort legend entries in a reverse order -->
