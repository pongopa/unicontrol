...
function ver_documento2(url_busqueda,ID){
	new Ajax.Updater2(ID ,url_busqueda, {asynchronous:true, evalScripts:true, onLoading:function(request){Element.show('mini_loading');}, onComplete:function(request){Element.hide('mini_loading')}, requestHeaders:['X-Update', ID]})
...
function ventanaGoogleMap(){
  ...
  var ventana = window.open('/adm_mapas/buscar_puntos',"GOOGLE_MAPA_FIND2","width=590,height=420,fullscreen=0,scrollbars=no,resizable=no,location=no,status=no,menubar=no,toolbar=no,titlebar=no");
}
