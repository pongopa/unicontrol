<div class="proveedores form">
	<?php echo $this->Ajax->form('Proveedore','post',array('model'=>'Proveedore','url'=>'/Proveedores/edit','update'=>'principal_add'));?>
	...
	<fieldset class="fieldset_marco">
 		<legend class="titulo_marco"><?php echo __('Editar Proveedor'); ?></legend>
		...
		<table>
				...
				<tr>
					<td><?php echo $this->Form->input('ruc',array('label'=>false, 'ReadOnly'=>true));?></td>
       ...
       <table  border="1">
					...
					<tr>
						<td>
								<?php $this->Proveedor->create_contato(array('del'=>2)); ?>
					    </td>
					</tr>
		</table>
		<br>
       <table  border="1">
					...
					<tr>
						<td>
								<?php $this->Proveedor->create_banco(array('del'=>2)); ?>
						</td>
					</tr>
		</table>
		<br>
		<table  border="1">
					...
					<tr>
						<td>
								<?php $this->Proveedor->create_rubro(array('del'=>2)); ?>
						</td>
					</tr>
		</table>
		 <?php /**/ ?>
