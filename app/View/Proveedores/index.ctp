...
<div class="proveedores index">
	...
	<tr>
		<td><?php echo h($proveedore['Proveedore']['ruc']); ?>&nbsp;</td>
		<td><?php echo h($proveedore['Proveedore']['nombre_comercial']); ?>&nbsp;</td>
		<td><?php echo h($proveedore['Estadocontribuyente']['denominacion']); ?>&nbsp;</td>
		<td class="actions">
			<?php echo $this->Ajax->link2($this->Html->image('acciones/view.png',array('border'=>0)),  '/Proveedores/view/'.$proveedore['Proveedore']['id'].'/'.$page,  array('update'=>'principal','title'=>'Ver','escape'=>false),null); ?>
			<?php echo $this->Ajax->link2($this->Html->image('acciones/edit.png',array('border'=>0)),  '/Proveedores/edit/'.$proveedore['Proveedore']['id'].'/'.$page,  array('update'=>'principal','title'=>'Editar','escape'=>false),null); ?>
			<?php echo $this->Ajax->link2($this->Html->image('acciones/delete.png',array('border'=>0)),'/Proveedores/delete/'.$proveedore['Proveedore']['id'].'/'.$page,array('update'=>'principal','title'=>'Eliminar','escape'=>false),'Está seguro que desea eliminar el registro indicado?'); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
