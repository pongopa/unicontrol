<div class="clientesucursas form">
   	<?php echo $this->Ajax->form('Clientesucursa','post',array('model'=>'Clientesucursa','url'=>'/clientesucursas/add','update'=>'principal_add'));?>
	<fieldset class="fieldset_marco">
 		<legend class="titulo_marco"><?php echo __('Agregar Cliente sucursal'); ?></legend>
