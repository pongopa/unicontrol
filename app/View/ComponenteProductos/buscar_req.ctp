...
<div class="confDireccionConectadas index" style="height:300px; overflow:auto;">
	...
	<tr>
			...
			<td width="50%" align="left"><?php echo $this->Paginator->sort('denominacion','Dscripción');?></td>
	...
	<tr<?php echo $class;?>>
		...
		<td class="actions">
			<?php echo $this->Ajax->link2($this->Html->image('acciones/view.png',array('border'=>0)),'/ComponenteProductos/seleccion_producto_req/'.$CatalogoProducto['Producto']['id'],array('onclick'=>'jQuery.modal.close();', 'update'=>'seleccion_producto','title'=>'Ver','escape'=>false),null); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
