...
<table cellpadding="0" cellspacing="0" class="grilla" border="0">
	   ...
	   echo'<td valign="top">';
	     echo $this->Form->input('ComponenteProducto.cantidad',        array('id'=>'cantidad',        'label'=>false, 'readonly'=>false,'style'=>"text-align: center;", 'size'=>8, 'onkeypress'=>'return numeros_con_punto(event);'));
	   echo'</td>';
