...
<?php echo $this->Ajax->form('Productostipo','post',array('model'=>'Productostipo','url'=>'/Productostipos/edit','update'=>'principal_add'));?>
	<fieldset class="fieldset_marco">
 		<legend class="titulo_marco"><?php echo __('Editar tipo Productos ó Servicio'); ?></legend>
