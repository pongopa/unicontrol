...
<?php echo $this->Ajax->form('Clientesvendedore','post',array('model'=>'Clientesvendedore','url'=>'/Clientesvendedores/edit','update'=>'principal_add'));?>
	<fieldset class="fieldset_marco">
 		<legend class="titulo_marco"><?php echo __('Editar Cliente contacto'); ?></legend>
