...
<?php echo $this->Ajax->form('Formapago','post',array('model'=>'Formapago','url'=>'/Formapagos/add','update'=>'principal_add'));?>
	<fieldset class="fieldset_marco">
 		<legend class="titulo_marco"><?php echo __('Agregar Forma de pago'); ?></legend><div id="principal_add"></div>
	<?php
