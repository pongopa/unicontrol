...
<?php echo $this->Ajax->form('Proveedoresbanco','post',array('model'=>'Proveedoresbanco','url'=>'/Proveedoresbancos/edit','update'=>'principal_add'));?>
	<fieldset class="fieldset_marco">
 		<legend class="titulo_marco"><?php echo __('Editar Proveedor banco'); ?></legend>
