...
<div class="productos index">
	...
	<tr>
	        ...
	        <th><?php echo $this->Paginator->sort('productostipo_id');?></th>
			<th><?php echo $this->Paginator->sort('denominacion');?></th>
			<th><?php echo $this->Paginator->sort('productosmedida_id');?></th>
	...
	<tr>
		...
		<td><?php echo h($producto['Producto']['denominacion']); ?>&nbsp;</td>
		<td>
			<?php echo h($producto['Productosmedida']['denominacion']); ?>
		</td>
		<td><?php echo h($producto['Producto']['descripcion']); ?>&nbsp;</td>
		<td class="actions">
			<?php echo $this->Ajax->link2($this->Html->image('acciones/view.png',array('border'=>0)),  '/Productos/view/'.$producto['Producto']['id'].'/'.$page,  array('update'=>'principal','title'=>'Ver','escape'=>false),null); ?>
			<?php echo $this->Ajax->link2($this->Html->image('acciones/edit.png',array('border'=>0)),  '/Productos/edit/'.$producto['Producto']['id'].'/'.$page,  array('update'=>'principal','title'=>'Editar','escape'=>false),null); ?>
			<?php echo $this->Ajax->link2($this->Html->image('acciones/delete.png',array('border'=>0)),'/Productos/delete/'.$producto['Producto']['id'].'/'.$page,array('update'=>'principal','title'=>'Eliminar','escape'=>false),'Está seguro que desea eliminar el registro indicado?'); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
