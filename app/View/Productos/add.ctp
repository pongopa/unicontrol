...
<?php echo $this->Ajax->form('Producto','post',array('model'=>'Producto','url'=>'/Productos/add','update'=>'principal_add'));?>
	<fieldset class="fieldset_marco">
 		<legend class="titulo_marco"><?php echo __('Agregar Producto ó Servicio'); ?></legend>
 		<div id="principal_add"></div>
 		<table>
			<tr>
					<td><?php echo $this->Form->input('clasificacion',array('label'=>false,'type'=>'radio','value'=>'1','options'=>array('1'=>'Producto','2'=>'Servicio'))); ?></td>
			</tr>
		</table>
 		<table>
 			<tr>
