...
<?php echo $this->Ajax->form('Productosmedida','post',array('model'=>'Productosmedida','url'=>'/Productosmedidas/edit','update'=>'principal_add'));?>
<?php echo $this->Form->input('id',array('label'=>false)); ?>
	<fieldset class="fieldset_marco">
 		<legend class="titulo_marco"><?php echo __('Editar Productos medida'); ?></legend>
