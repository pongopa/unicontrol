...
?>
<div class="productosmedidas index">
	...
	<?php
	$i = 0;
	foreach ($productosmedidas as $productosmedida): ?>
	<tr>
		<td><?php echo h($productosmedida['Productosmedida']['denominacion']); ?>&nbsp;</td>
		<td><?php echo h($productosmedida['Productosmedida']['abreviacion']); ?>&nbsp;</td>
		<td class="actions">
			<?php echo $this->Ajax->link2($this->Html->image('acciones/view.png',array('border'=>0)),  '/Productosmedidas/view/'.$productosmedida['Productosmedida']['id'].'/'.$page,  array('update'=>'principal','title'=>'Ver','escape'=>false),null); ?>
			<?php echo $this->Ajax->link2($this->Html->image('acciones/edit.png',array('border'=>0)),  '/Productosmedidas/edit/'.$productosmedida['Productosmedida']['id'].'/'.$page,  array('update'=>'principal','title'=>'Editar','escape'=>false),null); ?>
			<?php echo $this->Ajax->link2($this->Html->image('acciones/delete.png',array('border'=>0)),'/Productosmedidas/delete/'.$productosmedida['Productosmedida']['id'].'/'.$page,array('update'=>'principal','title'=>'Eliminar','escape'=>false),'Está seguro que desea eliminar el registro indicado?'); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
