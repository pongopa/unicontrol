...
<?php echo $this->Ajax->form('Serviciosrealizado','post',array('model'=>'Serviciosrealizado','url'=>'/Serviciosrealizados/edit','update'=>'principal_add'));?>
...
?>
	<fieldset class="fieldset_marco">
 		<legend class="titulo_marco"><?php echo __('Editar Servicios realizado'); ?></legend>
		...
		<table>
			...
			<tr>
					...
					<td><?php echo $this->Form->input('facturado',array('label'=>false,'type'=>'radio','options'=>array('1'=>'Si','2'=>'No'))); ?></td>
					<td><?php echo $this->Form->input('numero_factura', array('label'=>false));?></td>
			</tr>
		</table>
		<table>
			<tr>
					<td><?php echo $this->Form->input('tareo',array('label'=>false,'type'=>'radio','options'=>array('1'=>'Si','2'=>'No'))); ?></td>
					<td><?php echo $this->Form->input('informe',array('label'=>false,'type'=>'radio','options'=>array('1'=>'Si','2'=>'No'))); ?></td>
					<td><?php echo $this->Form->input('conformidad',array('label'=>false,'type'=>'radio','options'=>array('1'=>'Si','2'=>'No'))); ?></td>
			</tr>
		</table>
		<table>
			<tr>
