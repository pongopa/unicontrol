...
?>
<div class="ordencomprastipos index">
	...
	<?php
	$i = 0;
	foreach ($ordencomprastipos as $ordencomprastipo): ?>
	<tr>
		<td><?php echo h($ordencomprastipo['Ordencomprastipo']['denominacion']); ?>&nbsp;</td>
		<td class="actions">
					<?php echo $this->Ajax->link2($this->Html->image('acciones/view.png',array('border'=>0)),  '/Ordencomprastipos/view/'.$ordencomprastipo['Ordencomprastipo']['id'].'/'.$page,  array('update'=>'principal','title'=>'Ver','escape'=>false),null); ?>
					<?php echo $this->Ajax->link2($this->Html->image('acciones/edit.png',array('border'=>0)),  '/Ordencomprastipos/edit/'.$ordencomprastipo['Ordencomprastipo']['id'].'/'.$page,  array('update'=>'principal','title'=>'Editar','escape'=>false),null); ?>
					<?php echo $this->Ajax->link2($this->Html->image('acciones/delete.png',array('border'=>0)),'/Ordencomprastipos/delete/'.$ordencomprastipo['Ordencomprastipo']['id'].'/'.$page,array('update'=>'principal','title'=>'Eliminar','escape'=>false),'Está seguro que desea eliminar el registro indicado?'); ?>
				</td>
	</tr>
<?php endforeach; ?>
	</table>
