...
<?php echo $this->Ajax->form('Ordencomprastipo','post',array('model'=>'Ordencomprastipo','url'=>'/Ordencomprastipos/edit','update'=>'principal_add'));?>
	<fieldset class="fieldset_marco">
 		<legend class="titulo_marco"><?php echo __('Editar Orden compras tipo'); ?></legend>
