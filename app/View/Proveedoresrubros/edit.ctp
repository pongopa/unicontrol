...
<?php echo $this->Ajax->form('Proveedoresrubro','post',array('model'=>'Proveedoresrubro','url'=>'/Proveedoresrubros/edit','update'=>'principal_add'));?>
	<fieldset class="fieldset_marco">
 		<legend class="titulo_marco"><?php echo __('Editar Proveedor rubro'); ?></legend>
