<div class="formaentregas form">
   	<?php echo $this->Ajax->form('Formaentrega','post',array('model'=>'Formaentrega','url'=>'/formaentregas/edit','update'=>'principal_add'));?>
	<fieldset class="fieldset_marco">
 		<legend class="titulo_marco"><?php echo __('Editar Forma entrega'); ?></legend>
