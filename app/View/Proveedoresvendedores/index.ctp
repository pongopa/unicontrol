...
?>
<div class="proveedoresvendedores index">
	...
	<?php
	$i = 0;
	foreach ($proveedoresvendedores as $proveedoresvendedore): ?>
	<tr>
		<td>
			<?php echo h($proveedoresvendedore['Proveedore']['ruc']); ?>
		</td>
		<td><?php echo h($proveedoresvendedore['Proveedoresvendedore']['nombres_y_apellidos']); ?>&nbsp;</td>
		<td><?php echo h($proveedoresvendedore['Proveedoresvendedore']['cell_1']); ?>&nbsp;</td>
		<td><?php echo h($proveedoresvendedore['Proveedoresvendedore']['email_1']); ?>&nbsp;</td>
		<td class="actions">
			<?php echo $this->Ajax->link2($this->Html->image('acciones/view.png',array('border'=>0)),  '/Proveedoresvendedores/view/'.$proveedoresvendedore['Proveedoresvendedore']['id'].'/'.$page,  array('update'=>'principal','title'=>'Ver','escape'=>false),null); ?>
			<?php echo $this->Ajax->link2($this->Html->image('acciones/edit.png',array('border'=>0)),  '/Proveedoresvendedores/edit/'.$proveedoresvendedore['Proveedoresvendedore']['id'].'/'.$page,  array('update'=>'principal','title'=>'Editar','escape'=>false),null); ?>
			<?php echo $this->Ajax->link2($this->Html->image('acciones/delete.png',array('border'=>0)),'/Proveedoresvendedores/delete/'.$proveedoresvendedore['Proveedoresvendedore']['id'].'/'.$page,array('update'=>'principal','title'=>'Eliminar','escape'=>false),'Está seguro que desea eliminar el registro indicado?'); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
