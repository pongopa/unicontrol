...
<?php echo $this->Ajax->form('Proveedoresvendedore','post',array('model'=>'Proveedoresvendedore','url'=>'/Proveedoresvendedores/add','update'=>'principal_add'));?>
	<fieldset class="fieldset_marco">
 		<legend class="titulo_marco"><?php echo __('Agregar Proveedor vendedor'); ?></legend>
