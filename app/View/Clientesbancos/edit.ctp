...
<?php echo $this->Ajax->form('Clientesbanco','post',array('model'=>'Clientesbanco','url'=>'/Clientesbancos/edit','update'=>'principal_add'));?>
	<fieldset class="fieldset_marco">
 		<legend class="titulo_marco"><?php echo __('Editar Cliente banco'); ?></legend>
