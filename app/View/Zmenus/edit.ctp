...
<?php echo $this->Ajax->form('Zmenu','post',array('model'=>'Zmenu','url'=>'/zmenus/add','update'=>'principal'));?>
	...
	<fieldset class="fieldset_marco">
 		<legend class="titulo_marco"><?php __('Edit Zmenu'); ?></legend>
...
<table>
		...
		<tr><td>id menu</td></tr>
		<tr><td  id="select_menu"><?php echo $this->Form->input('id_menu',array('label'=>false,'options'=>$zmenus,'url'=>'/zmenus/mostrar_nivel_orden','update'=>'mostrar_nivel_orden')); ?></td></tr>
		<tr><td>denominación menu</td></tr>
		<tr><td><?php echo $this->Form->input('deno_menu',array('label'=>false)); ?></td></tr>
		<tr><td>url programa</td></tr>
		<tr><td><?php echo $this->Form->input('url',array('label'=>false)); ?></td></tr>
		<tr><td>idcapa</td></tr>
		<tr><td><?php echo $this->Form->input('idcapa',array('label'=>false,'options'=>array('principal'=>'PRINCIPAL','no_ajax'=>'NO AJAX','NULL'=>'NULL'))); ?></td></tr>
        <tr><td>nivel</td></tr>
		...
		<tr><td><?php echo $this->Form->input('principal',array('label'=>false,'type'=>'radio','options'=>array('1'=>'Si','0'=>'No'),'legend'=>false)); ?></td></tr>

        <tr><td>Principal Dependencia</td></tr>
		<tr><td><?php echo $this->Form->input('principal_dependencia',array('label'=>false,'type'=>'radio','options'=>array('1'=>'Si','0'=>'No'),'legend'=>false)); ?></td></tr>
