<?php
 ...
 ?>
<div class="confDepartamentos index">
	...
	<?php
	$i = 0;
	foreach ($confDepartamentos as $confDepartamento): ?>
	<tr>
		<td>
			<?php echo h($confDepartamento['ConfPai']['denominacion']); ?>
		</td>
		<td><?php echo h($confDepartamento['ConfDepartamento']['denominacion']); ?>&nbsp;</td>
		<td class="actions">
			<?php echo $this->Ajax->link2($this->Html->image('acciones/view.png',array('border'=>0)),'/confDepartamentos/view/'.$confDepartamento['ConfDepartamento']['id'].'/'.$page,array('update'=>'principal','title'=>'Ver','escape'=>false),null); ?>
			<?php echo $this->Ajax->link2($this->Html->image('acciones/edit.png',array('border'=>0)),'/confDepartamentos/edit/'.$confDepartamento['ConfDepartamento']['id'].'/'.$page,array('update'=>'principal','title'=>'Editar','escape'=>false),null); ?>
			<?php echo $this->Ajax->link2($this->Html->image('acciones/delete.png',array('border'=>0)),'/confDepartamentos/delete/'.$confDepartamento['ConfDepartamento']['id'].'/'.$page,array('update'=>'principal','title'=>'Eliminar','escape'=>false),'Está seguro que desea eliminar el registro indicado?'); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
