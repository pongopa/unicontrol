...
?>
<div class="clientesrubros index">
	...
	<?php
	$i = 0;
	foreach ($clientesrubros as $clientesrubro): ?>
	<tr>
		<td>
		...
		<td class="actions">
			<?php echo $this->Ajax->link2($this->Html->image('acciones/view.png',array('border'=>0)),  '/Clientesrubros/view/'.$clientesrubro['Clientesrubro']['id'].'/'.$page,  array('update'=>'principal','title'=>'Ver','escape'=>false),null); ?>
			<?php echo $this->Ajax->link2($this->Html->image('acciones/edit.png',array('border'=>0)),  '/Clientesrubros/edit/'.$clientesrubro['Clientesrubro']['id'].'/'.$page,  array('update'=>'principal','title'=>'Editar','escape'=>false),null); ?>
			<?php echo $this->Ajax->link2($this->Html->image('acciones/delete.png',array('border'=>0)),'/Clientesrubros/delete/'.$clientesrubro['Clientesrubro']['id'].'/'.$page,array('update'=>'principal','title'=>'Eliminar','escape'=>false),'Está seguro que desea eliminar el registro indicado?'); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
